module github.com/maguowei/gotobeta
...
// shellescape v1.5.0+ 将 module path 改名为 al.essio.dev/pkg/shellescape，
// 但 lefthook 仍以旧路径 import；replace 把旧路径钉在最后一个有效版本，
// 防止 go mod tidy 解析到改名后的新版本而失败。
replace github.com/alessio/shellescape => github.com/alessio/shellescape v1.4.1
