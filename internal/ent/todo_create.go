...
func (_c *TodoCreate) SetBizID(v int64) *TodoCreate {
...
func (_c *TodoCreate) SetStatus(v string) *TodoCreate {
	_c.mutation.SetStatus(v)
	return _c
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (_c *TodoCreate) SetNillableStatus(v *string) *TodoCreate {
	if v != nil {
		_c.SetStatus(*v)
	}
	return _c
...
func (_c *TodoCreate) SetNillableVersion(v *int) *TodoCreate {
	if v != nil {
		_c.SetVersion(*v)
	}
	return _c
...
func (_c *TodoCreate) check() error {
	...
	if _, ok := _c.mutation.BizID(); !ok {
		return &ValidationError{Name: "biz_id", err: errors.New(`ent: missing required field "Todo.biz_id"`)}
	}
...
func (_c *TodoCreate) createSpec() (*Todo, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.BizID(); ok {
		_spec.SetField(todo.FieldBizID, field.TypeInt64, value)
		_node.BizID = value
	}
