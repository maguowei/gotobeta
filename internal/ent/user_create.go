...
func (_c *UserCreate) SetBizID(v int64) *UserCreate {
...
func (_c *UserCreate) SetEmailNormalized(v string) *UserCreate {
	_c.mutation.SetEmailNormalized(v)
	return _c
}
...
func (_c *UserCreate) SetPasswordHashAlg(v string) *UserCreate {
	_c.mutation.SetPasswordHashAlg(v)
	return _c
}

// SetNillablePasswordHashAlg sets the "password_hash_alg" field if the given value is not nil.
func (_c *UserCreate) SetNillablePasswordHashAlg(v *string) *UserCreate {
	if v != nil {
		_c.SetPasswordHashAlg(*v)
	}
	return _c
}

// SetPasswordSetAt sets the "password_set_at" field.
func (_c *UserCreate) SetPasswordSetAt(v time.Time) *UserCreate {
	_c.mutation.SetPasswordSetAt(v)
	return _c
}

// SetNillablePasswordSetAt sets the "password_set_at" field if the given value is not nil.
func (_c *UserCreate) SetNillablePasswordSetAt(v *time.Time) *UserCreate {
	if v != nil {
		_c.SetPasswordSetAt(*v)
	}
	return _c
}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.BizID(); !ok {
		return &ValidationError{Name: "biz_id", err: errors.New(`ent: missing required field "User.biz_id"`)}
	}
	...
	if _, ok := _c.mutation.EmailNormalized(); !ok {
		return &ValidationError{Name: "email_normalized", err: errors.New(`ent: missing required field "User.email_normalized"`)}
	}
	if v, ok := _c.mutation.EmailNormalized(); ok {
	...
	if v, ok := _c.mutation.PasswordHashAlg(); ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.BizID(); ok {
		_spec.SetField(user.FieldBizID, field.TypeInt64, value)
		_node.BizID = value
	}
	...
	if value, ok := _c.mutation.EmailNormalized(); ok {
	...
	if value, ok := _c.mutation.PasswordHashAlg(); ok {
		_spec.SetField(user.FieldPasswordHashAlg, field.TypeString, value)
		_node.PasswordHashAlg = &value
	}
	if value, ok := _c.mutation.PasswordSetAt(); ok {
		_spec.SetField(user.FieldPasswordSetAt, field.TypeTime, value)
		_node.PasswordSetAt = &value
	}
